    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.CharField(default='Anonymous', max_length=30, verbose_name='Created_by')),
                ('categories', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='post.category', verbose_name='Category')),
