...
from authy.views import UserProfile, Login, Signup, PasswordChange, PasswordChangeDone, EditProfile
...
urlpatterns = [
    ...
    path('passwordreset/complete/',authViews.PasswordResetCompleteView.as_view(template_name='password_reset_complete.html'), name='password_reset_complete'),
